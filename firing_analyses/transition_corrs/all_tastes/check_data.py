    ...
    def check_pkl_counts(self):
        ...
        if len(self.pkl_file_paths):
            ...
            self.split_inds = [num for num,path in enumerate(self.pkl_basenames) \
                    if 'split_' in path]
            self.region_fit_inds = [num for num,path in enumerate(self.pkl_basenames) \
                    if 'region_' in path]
