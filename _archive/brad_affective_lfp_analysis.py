...
Edits:
    - Clean file loading code
    - Move code for affective analysis to different script
    - For pairwise t-test over bands and trial bins, use chronological
        to make new trial bins which don't rely on tastes
    - Save output plots
    - Save extracted ITIs to HDF5 file
"""
