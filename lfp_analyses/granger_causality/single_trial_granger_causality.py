...
plot_dir = os.path.join(plot_dir_base, 'single_trial_causality')
...
for dir_name in dir_list:
    ...
    #        return np.nan
    #
    #model_orders = [parallelize(temp_fit, x) for x in tqdm(input_data_epochs)]
    #chosen_model_order_list = [int(np.nanmedian(x)) for x in model_orders]
